                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.Sliders')}}</h5>
                            </li>
                        </ul>
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.Sliders')}}
                    </div>
            ...
            <span class="svg-icon svg-icon-md">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        <tr>
                            ...
                            <th class="headerr">#</th>
                            <th class="headerr">{{__('lang.ar_title')}} </th>
                            <th class="headerr">{{__('lang.en_title')}} </th>
                            <th class="headerr">{{__('lang.image')}} </th>
                        ...
                        @foreach($Users as $Key => $User)
                            ...
                            <td>{{$User->en_title}}</td>
                            <td><img src="{{$User->image}}" width="50px" height="50px" alt="slider image"></td>
                            <td nowrap="nowrap">
                ...
                <h3>اجمالي : @inject('AllUsers','App\Models\Slider') {{$Users->count()}} </h3>
            </div>
            <!--end::Card-->
        </div>
        <!--end::Container-->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="get" action="{{url('SlidersSearch')}}">
                        <div class="col-xl-12">
                            <div class="kt-section__body">

                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label"> {{__('lang.search')}}</label>
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="en_description"  class="form-control form-control-solid" id="" dir="ltr">
...
{{--                            <select  class="form-control form-control-solid " name="advertising_id" id="" >--}}
{{--                                <option value="" selected>{{trans('lang.none')}}</option>--}}
{{--                                @foreach(\App\Models\Advertising::all() as $item)--}}
{{--                                    <option value="{{$item->id}}">{{$item->ar_title}}</option>--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
{{--                        </div>--}}
                        <div class="form-group">
