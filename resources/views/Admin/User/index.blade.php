            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <button  style="margin: 6px"  type="button" data-toggle="modal" data-toggle="modal" data-target="#kt_modal_5" class="btn btn-success font-weight-bolder">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        <tr style='  font-weight: bold!important;'>
                            ...
                            <th class="headerr">{{__('lang.Projects')}} </th>
                        ...
                        @foreach($Users as  $Key => $User)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a  class="btn btn-success "   href="{{url('UserProjects/'.$User->id)}}" >
                                        {{__('lang.Projects')}}
                                    </a>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="get" action="{{url('UsersSearch')}}">
                        <div class="col-xl-12">
