                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.Users')}}</h5>
                            </li>
                        </ul>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.Users')}}
                    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        <tr>
                            ...
                            @endif
                            @can('Reciepts')
                                <th class="headerr">{{__('lang.bonds')}} </th>
                            @endcan
                                    ...
                                    <td>
                                        @if (Auth::user()->can('sell-contracts')  )
                                            <a class="btn btn-primary btn-block"
                                               href="{{url('client-sell-contracts/'.$User->id)}}"
                                            > {{__('lang.SellContract')}}</a>
                                        @endif
                                        @if ( Auth::user()->can('rent-contracts') )
                                            <a class="btn btn-success btn-block"
                                               href="{{url('client-rent-contracts/'.$User->id)}}"
                                ...
                                @can('Reciepts')
                                    <td>
                                        <a class="btn btn-success"
                                           href="{{url('receipt/'.$User->id)}}"> {{__('lang.bonds')}}</a>
                                    </td>
                                @endcan
                                <td nowrap="nowrap">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="get" action="{{url('ClientsSearch')}}">
                        <div class="col-xl-12">
