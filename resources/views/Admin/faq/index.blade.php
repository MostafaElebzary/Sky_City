                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.faq')}}</h5>
                            </li>
                        </ul>
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.faq')}}
                    </div>
            ...
            <span class="svg-icon svg-icon-md">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <h3>اجمالي : @inject('AllUsers','App\Models\Faq') {{$Users->count()}} </h3>
            </div>
            <!--end::Card-->
        </div>
        <!--end::Container-->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="get" action="{{url('faqSearch')}}">
                        <div class="col-xl-12">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                          action="{{url('Create_faq')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <input type="radio" class="form-control form-control-solid col-6" id="yes"
                                       name="is_visible"
                                       value="1" checked>
