...
<html direction="rtl" dir="rtl" style="direction: rtl" >
	...
	<head><base href="../../../../">
		...
		<title>  sky city || تسجيل الدخول  </title>
						...
						<div class="login-form">
                            ...
                            <form class="form" action="/UserLogin" method="POST">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0 @error('national_id') is-invalid @enderror" id="phone" type="text" name="phone"  placeholder="رقم الجوال" value="{{ old('phone') }}" required autocomplete="email" autofocus />
                                    @error('email')
