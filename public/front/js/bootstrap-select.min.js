    ...
    (function (g) {
        if (!String.prototype.includes) {
            (function () {
                ...
                if (n) {
                    n(String.prototype, "includes", {value: o, configurable: true, writable: true,})
                } else {
        ...
        if (!String.prototype.startsWith) {
            (function () {
                ...
                if (n) {
                    n(String.prototype, "startsWith", {value: o, configurable: true, writable: true,})
                } else {
        ...
        var e = {useDefault: false, _set: g.valHooks.select.set,};
        ...
        k.prototype = {
            constructor: k, init: function () {
                var n = this, o = this.$element.attr("id");
            ...
            , createView: function () {
                var o = this.createDropdown(), n = this.createLi();
            ...
            createLi: function () {
                var u = this, t = [], x = 0, n = document.createElement("option"), q = -1;
                ...
                o.each(function (C) {
                    ...
                    var E = this.className || "", A = l(this.style.cssText),
                        ...
                        J = B.parent(), z = J[0].tagName === "OPTGROUP", M = z && J[0].disabled, G = this.disabled || M,
                        y;
                    if (O !== "" && G) {
                        O = "<span>" + O + "</span>"
                    }
            ...
            render: function (r) {
                var q = this, n, o = this.$element.find("option");
                if (r !== false) {
                    o.each(function (w) {
                ...
                var r = document.createElement("div"), n = document.createElement("div"),
                    x = document.createElement("ul"), F = document.createElement("a"), E = document.createElement("a"),
                    J = document.createElement("span"), D = document.createElement("span"),
                ...
                var p = J.offsetHeight, H = I ? I.offsetHeight : 0, A = y ? y.offsetHeight : 0,
                    w = z ? z.offsetHeight : 0, s = q ? q.offsetHeight : 0, C = g(F).outerHeight(true),
                    o = typeof getComputedStyle === "function" ? getComputedStyle(n) : false, u = o ? null : g(n), G = {
                ...
                var y = this, v = this.$menu, r = this.$menuInner, D = g(window), L = this.$newElement[0].offsetHeight,
                    N = this.$newElement[0].offsetWidth, s = this.sizeInfo.liHeight, H = this.sizeInfo.headerHeight,
                    A = this.sizeInfo.searchHeight, x = this.sizeInfo.actionsHeight, t = this.sizeInfo.doneButtonHeight,
                    z = this.sizeInfo.dividerHeight, G = this.sizeInfo.menuPadding, w = this.sizeInfo.menuExtras,
                    E = this.options.hideDisabled ? ".disabled" : "", F, n, B, p, M, K, u, J, I = function () {
                        var R = y.$newElement.offset(), P = g(y.options.container), Q;
                ...
                if (this.options.size === "auto") {
                    var q = function () {
                        ...
                        v.css({"max-height": F + "px", overflow: "hidden", "min-height": R + H + A + x + t + "px",});
                        r.css({
                    ...
                    if (this.options.size && this.options.size != "auto" && this.$lis.not(E).length > this.options.size) {
                        ...
                        v.css({"max-height": F + H + A + x + t + "px", overflow: "hidden", "min-height": "",});
                        r.css({"max-height": F - G.vert + "px", "overflow-y": "auto", "min-height": "",})
                    }
                }
            }, setWidth: function () {
                ...
                var o = this, p = g(this.options.container), s, r, q, n = function (t) {
                    ...
                    o.$bsContainer.css({top: s.top - r.top + q, left: s.left - r.left, width: t[0].offsetWidth,})
                };
                ...
                this.$menuInner.on("click", "a", function (G) {
                    var v = g(this).find("span.dropdown-item-inner"), q = v.parent().data("originalIndex"),
                        E = n.$element.val(), x = n.$element.prop("selectedIndex"), y = true;
                    if (n.multiple && n.options.maxOptions !== 1) {
                        G.stopPropagation()
                    }
                    G.preventDefault();
                    if (!n.isDisabled() && !v.parent().hasClass("disabled")) {
                        var C = n.$element.find("option"), D = C.eq(q), s = D.prop("selected"),
                            B = D.parent("optgroup"), I = n.options.maxOptions, z = B.data("maxOptions") || false;
                        if (!n.multiple) {
                            ...
                            v.blur();
                            if (I !== false || z !== false) {
                                var r = I < C.filter(":selected").length, u = z < B.find("option:selected").length;
                                if ((I && r) || (z && u)) {
                                    if (I && I == 1) {
                                        C.prop("selected", false);
                                        D.prop("selected", true);
                                        ...
                                        if (z && z == 1) {
                                            ...
                                            var p = typeof n.options.maxOptionsText === "string" ? [n.options.maxOptionsText, n.options.maxOptionsText] : n.options.maxOptionsText,
                                                t = typeof p === "function" ? p(I, z) : p, H = t[0].replace("{n}", I),
                                                w = t[1].replace("{n}", z), A = g('<div class="notify"></div>');
                                            if (t[2]) {
                ...
                var o = this, n = g('<li class="no-results"></li>');
                ...
                this.$searchbox.on("input propertychange", function () {
                    ...
                    n.remove();
                    if (o.$searchbox.val()) {
                        var q = o.$lis.not(".is-hidden, .dropdown-divider, .dropdown-header"), p;
                ...
                var n = {begins: "ibegins", startsWith: "ibegins",};
                ...
                var n = this.$element.find("option"),
                    t = this.$lis.not(".dropdown-divider, .dropdown-header, .disabled, .d-none"), p = t.length, s = [];
                if (o) {
                ...
                var y = g(this), s = y.is("input") ? y.parent().parent() : y.parent(), w, u = s.data("this"), v, q, z,
                    p = ":not(.disabled, .d-none, .dropdown-header, .dropdown-divider)", r = {
                        32: " ",
                        48: "0",
                        49: "1",
                        50: "2",
        ...
        function j(p) {
            ...
            var o = this.each(function () {
                var w = g(this);
                if (w.is("select")) {
                    var v = w.data("selectpicker"), t = typeof r == "object" && r;
                    if (!v) {
