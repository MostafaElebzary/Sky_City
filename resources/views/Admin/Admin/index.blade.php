                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                                        <li class="breadcrumb-item">
                                                            <a href="{{url('Admin-Panel')}}" class="text-muted">{{__('lang.Home')}}</a>
                                                        </li>
                                                        <li class="breadcrumb-item">
                                                            <a href="" class="text-muted">الاعدادات</a>
                                                        </li>
        ...
        <div class="container">
            ...
            <span class="svg-icon svg-icon-md">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <h3>اجمالي  : @inject('AllUsers','App\Models\User') {{$Users->count()}} </h3>
            </div>
            <!--end::Card-->
        </div>
        <!--end::Container-->
    ...
    <div class="modal fade" id="kt_modal_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form"  method="post" action="{{url('Create_Admins')}}" enctype="multipart/form-data">
                        @csrf
