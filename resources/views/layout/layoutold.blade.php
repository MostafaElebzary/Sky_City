...
@if(session('lang') == 'en')
    ...
    @else
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            <!--begin::Logo-->
            <a href="/">
                <img alt="Logo" src="{{asset('front/1.jpeg')}}"/>
            </a>
            <!--end::Logo-->
            <!--begin::Toolbar-->
                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    ...
                    <div class="brand flex-column-auto" id="kt_brand">
                        ...
                        <a href="{{url('/')}}" class="brand-logo">
                            ...
                            <img alt="Logo" src="{{asset('front/Rustaq Aleaqaria Logo-01.png')}}" width="150px" height="50px"/>
                                ...
                                <div class="topbar-item" data-toggle="dropdown"
                                    ...
                                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary">
											<span id="notification"
                                                  class="svg-icon svg-icon-xl @if($unread_inbox->count() > 0)  svg-icon-danger @else svg-icon-primary @endif">
                                    ...
                                    <form>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane show p-8 active"
                                                ...
                                                @foreach($unread_inbox as $single_inbox)
                                                    <!--begin::Item-->
                                                        <div class="d-flex align-items-center mb-6">
                                                            ...
                                                            <div class="d-flex flex-column font-weight-bold">
                                                                <a href="{{url('Contact/'.$single_inbox->id)}}"
                                                                   class="text-dark text-hover-primary mb-1 font-size-lg">{{$single_inbox->subject}}</a>
                                                                <span
                                                                    class="text-muted">{{$single_inbox->name}}</span>
                                                            </div>
                                                            <!--end::Text-->
                                                        </div>
                                                        <!--end::Item-->
                ...
                <div class="d-flex align-items-center mt-5">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="navi mt-2">
                            ...
                            <a href="/logout"
                               class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">@if(session('lang') != 'en')
