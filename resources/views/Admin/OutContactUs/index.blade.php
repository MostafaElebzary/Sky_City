                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.ContactUs')}}</h5>
                            </li>
                        </ul>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.ContactUs')}}
                    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        @foreach($Users as $Key => $User)
                            <tr @if($User->is_read ==0) style="background-color: whitesmoke" @endif>
...
{{--                            <td>@if($User->advertising) <a target="_blank"--}}
{{--                                    href="{{url('Advertising/'.$User->advertising->id)}}"> {{$User->advertising->title}}</a>@else--}}
{{--                                    --- @endif</td>--}}
                            <td nowrap="nowrap">
                                <a  class="btn btn-primary btn-sm btn-clean btn-icon btn-icon-md edit-Advert"   data-id="{{$User->id}}" data-original-title="{{__('lang.Users_Edit')}}" title="{{__('lang.Users_Edit')}}">
