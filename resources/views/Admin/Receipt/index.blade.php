...
{{--                            </li>--}}
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{__('lang.Receipts')}}</h5>
                            </li>
                        </ul>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.Receipts')}}
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <button  style="margin: 6px"  type="button" data-toggle="modal"
                                 data-toggle="modal" data-target="#kt_modal_5" class="btn btn-success font-weight-bolder">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                        ...
                        <tr>
                            ...
                            <th  class="headerr">{{__('lang.pay_type')}} </th>
                            <th class="headerr"> {{__('lang.price')}}  </th>
{{--                            <th class="headerr"> {{__('lang.print_receipt')}}  </th>--}}
                        ...
                        @foreach($Users as $Key => $User)
                            <tr>
                                ...
                                <td>{{$User->ReceiptType->title}}</td>
                                <td>{{__('lang.'.$User->pay_type)}}</td>
                                <td>{{$User->price}}</td>
{{--                                <td nowrap="nowrap">--}}
{{--                                    <a href="{{url('printReceipt/'.$User->id)}}" target="_blank" class="btn btn-primary">{{__('lang.print_receipt')}}</a>--}}

{{--                                </td>--}}
                                <td nowrap="nowrap">
                                    <a href="{{url('view/'.$User->id)}}" target="_blank" class="btn btn-success">{{__('lang.view')}}</a>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="get" action="{{url('ReceiptSearch')}}">
                        <div class="col-xl-12">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <input type="date" class="form-control form-control-solid" name="from"  placeholder="{{__('lang.from')}}" >
                                    </div>
                                </div>
                                @if(isset($id))
            <input type="hidden" value="client_id" value="{{$id}}">
                    @endif
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label"> {{__('lang.to')}}</label>
                                    <div class="col-lg-9 col-xl-9">
                                        <input type="date" class="form-control form-control-solid" name="to"  placeholder="{{__('lang.to')}}" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <select name="pay_type" class="form-control">
                                            ...
                                            <option value="network">{{__('lang.network')}}</option>
                                            <option value="transfer">{{__('lang.transfer')}}</option>
                                            <option value="check">{{__('lang.check')}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="kt_modal_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form"  method="post" action="{{url('Create_Receipt')}}" enctype="multipart/form-data">
                        @csrf
                        @if($id == null)

                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label" >{{__('lang.client')}} </label>
                                <div class="col-lg-9 col-xl-9">
                                    <select style="width: 100%; height: 50px;   "  class="form-control" id="kt_select2_101" name="client_id">
                        ...
                        @else
                            ...
                            <input type="hidden" class="form-control form-control-solid" value="{{$id}}" name="client_id" required placeholder="{{__('lang.price')}}" >
                        @endif

                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 col-form-label" >{{__('lang.price')}} </label>
                            <div class="col-lg-9 col-xl-9">
                            <input type="number" class="form-control form-control-solid" name="price" required placeholder="{{__('lang.price')}}" >
                            </div>
                        </div>
                        ...
                        <div id="checkInputs" style="display: none;">
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label"> تاريخ الاستحقاق</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="date" class="form-control form-control-solid" name="check_date"  placeholder="تاريخ الاستحقاق" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control form-control-solid" name="bank_name"  placeholder="اسم البنك" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label"> رقم الشيك</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control form-control-solid" name="check_number"  placeholder="رقم الشيك" >
                                </div>
                            </div>
                        </div>
                        <div id="networkInputs" style="display: none;">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="datetime-local" class="form-control form-control-solid" name="network_date"  placeholder="{{__('lang.date')}}" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control form-control-solid" name="network_num"  placeholder="{{__('lang.network_num')}}" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
...
@section('js')
    ...
    <script>
        $('#pay_type').on('click , change',function () {
            if($('#pay_type').val() === 'network'){
