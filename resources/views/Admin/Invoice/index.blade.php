                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-hover table-checkable mt-10" id="kt_tdata">
                            ...
                            <tr>
                                ...
                                <th class="headerr" >#</th>
                                <th  class="headerr">نوع الفاتورة </th>
                                <th  class="headerr">اسم العميل </th>
                                <th  class="headerr"> عرض الفاتورة </th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @foreach($Invoices as $Key => $Invoice)
                                <tr>
                                    ...
                                    <td>{{$Invoice[0]['order_type'] == 0?'فاتورة شراء':"فاتورة مرتجع";}}</td>
                                    <td>{{$Invoice[0]['client_name']}}</td>
                                    <td nowrap="nowrap">
                                        <a href="{{url("show-invoices/" . $Invoice[0]['order_id'])}}" class="btn btn-info btn-sm btn-clean btn-icon btn-icon-md edit-Advert"   data-id="{{$Invoice[0]['order_id']}}" data-original-title="رؤية الفاتورة" title="رؤية الفاتورة">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="client_name" required placeholder="اسم العميل" >
                                </div>
                                <div class="form-group">
                                    <label>جوال العميل</label>
                                    <input type="number" class="form-control form-control-solid" name="client_phone" required placeholder="جوال العميل" >
                                </div>

                                <div class="form-group">
                                    <label>عنوان العميل</label>
                                    <input type="text" class="form-control form-control-solid" name="client_address" placeholder="عنوان العميل" >
                                </div>

                                <div class="form-group">
                                    <label>المحافظة</label>
                                    <input type="text" class="form-control form-control-solid" name="client_state" placeholder="المحافظة" >
                                </div>

                                <div class="form-group">
                                    <label>المدينة</label>
                                    <input type="text" class="form-control form-control-solid" name="client_city" placeholder="المدينة" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label>التاريخ</label>
                                    <input type="date" class="form-control form-control-solid" name="date" placeholder="التاريخ" >
                                </div>
                                <div class="form-group">
                                    <label>تاريخ الاصدار</label>
                                    <input type="date" class="form-control form-control-solid" name="issue_date" placeholder="تاريخ الاصدار" >
                                </div>
                                <div class="form-group">
                                    <label>تاريخ الاستحقاق</label>
                                    <input type="date" class="form-control form-control-solid" name="due_date" placeholder="تاريخ الاستحقاق" >
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid" name="description_ar[]" required placeholder="الوصف AR" >
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label>الوصف EN</label>
                                        <input type="text" class="form-control form-control-solid" name="description_en[]" required placeholder="الوصف EN" >
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label>الكمية</label>
                                        <input type="number" class="form-control form-control-solid" name="quantity[]" required placeholder="الكمية" >
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label>السعر</label>
                                        <input type="number" class="form-control form-control-solid" name="price[]" required placeholder="السعر" >
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label>الضريبة</label>
                                        <input type="number" class="form-control form-control-solid" name="vat[]" required placeholder="الضريبة" >
                                    </div>
                                </div>
...
@section('js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            fieldHTML +=             '<label>الوصف AR</label>';
            fieldHTML +=          '<input type="text" class="form-control form-control-solid" name="description_ar[]" required placeholder="الوصف AR" >';
            fieldHTML +=         '</div>';
            fieldHTML +=     '</div>';
            fieldHTML +=     '<div class="col-2">';
            fieldHTML +=         '<div class="form-group">';
            fieldHTML +=             '<label>الوصف EN</label>';
            fieldHTML +=             '<input type="text" class="form-control form-control-solid" name="description_en[]" required placeholder="الوصف EN" >';
            fieldHTML +=         '</div>';
            fieldHTML +=     '</div>';
            fieldHTML +=     '<div class="col-2">';
            fieldHTML +=         '<div class="form-group">';
            fieldHTML +=             '<label>الكمية</label>';
            fieldHTML +=             '<input type="number" class="form-control form-control-solid" name="quantity[]" required placeholder="الكمية" >';
            fieldHTML +=         '</div>';
            fieldHTML +=     '</div>';
            fieldHTML +=     '<div class="col-2">';
            fieldHTML +=         '<div class="form-group">';
            fieldHTML +=             '<label>السعر</label>';
            fieldHTML +=             '<input type="number" class="form-control form-control-solid" name="price[]" required placeholder="السعر" >';
            fieldHTML +=         '</div>';
            fieldHTML +=     '</div>';
            fieldHTML +=     '<div class="col-2">';
            fieldHTML +=         '<div class="form-group">';
            fieldHTML +=             '<label>الضريبة</label>';
            fieldHTML +=             '<input type="number" class="form-control form-control-solid" name="vat[]" required placeholder="الضريبة" >';
            fieldHTML +=         '</div>';
            fieldHTML +=     '</div>';
            ...
            if(dataList.length >0){
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        Swal.fire("{{__('lang.Cancelled')}}", "تم الغاء ارجاع الفاتورة", "error");
                    }
                });
            }
        });
