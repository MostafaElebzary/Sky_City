            ...
            <div class="card card-custom gutter-b">
                <div class="card-header ">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.CreateRentContract')}}
                    </div>
                </div>
                <div class="card-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                          action="{{url('rent-contract-store')}}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Card-->
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade " id="kt_tab_pane_2_3" role="tabpanel"
                                            ...
                                            @if(Request::segment(1) != 'Outrent-contracts')
                ...
                <span class="svg-icon svg-icon-md">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                    ...
                    <!--end::Svg Icon-->
                                            ...
                                            <div class="form-group">
                                                <label>{{__('lang.client_address')}} </label>
                                                <input type="text" class="form-control form-control-solid"
                                                       name="client_address" id="client_address" required
                                                       placeholder="{{__('lang.client_address')}}">
                                            </div>
                                        ...
                                        <div class="tab-pane fade show active" id="kt_tab_pane_3_3" role="tabpanel"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <select style="width: 100%" class="form-control" id="ad_id"
                                                        ...
                                                        @foreach($ads as $ad)
                                                            <option value="{{$ad->id}}">{{$ad->title}} - ({{$ad->owner ? $ad->owner->name : "--"}})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>{{__('lang.ad_city')}} </label>
                                                <input type="text" class="form-control form-control-solid"
                                                       name="ad_city" id="ad_city" required
                                                       placeholder="{{__('lang.ad_city')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>{{__('lang.ad_district')}} </label>
                                                <input type="text" class="form-control form-control-solid"
                                                       name="ad_district" id="ad_district" required
                                                       placeholder="{{__('lang.ad_district')}}">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="tab-pane fade " id="kt_tab_pane_4_3" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <label>{{__('lang.contract_start_date')}} </label>
                                                <input type="date" class="form-control form-control-solid"
                                                       name="contract_start_date" id="contract_start_date" required
                                                       placeholder="{{__('lang.contract_start_date')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>{{__('lang.contract_end_date')}} </label>
                                                <input type="date" class="form-control form-control-solid"
                                                       name="contract_end_date" id="contract_end_date" required
                                                       placeholder="{{__('lang.contract_end_date')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>{{__('lang.contract_duration')}} </label>
                                                <input type="text" min="0" class="form-control form-control-solid"
                                                       name="contract_duration" id="contract_duration" required
                                                       placeholder="{{__('lang.contract_duration')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>{{__('lang.annual_rent')}} </label>
                                                <input type="text"  class="form-control form-control-solid"
                                                       name="annual_rent" id="annual_rent" required
                                                       placeholder="{{__('lang.annual_rent')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>{{__('lang.contract_deposit')}} </label>
                                                <input type="text"  class="form-control form-control-solid"
                                                       name="contract_deposit" id="contract_deposit" required
                                                       placeholder="{{__('lang.contract_deposit')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>{{__('lang.insurance_amount')}} </label>
                                                <input type="text"  class="form-control form-control-solid"
                                                       name="insurance_amount" id="insurance_amount" required
                                                       placeholder="{{__('lang.insurance_amount')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>{{__('lang.rent_type')}} </label>
                                                <input type="text" class="form-control form-control-solid"
                                                       name="rent_type" id="rent_type" required
                                                       placeholder="{{__('lang.rent_type')}}">
                                            </div>
                                            <div class="form-group">
...
@section('js')
    ...
    <script>
        $("#client_id").change(function () {
            ...
            $.ajax({
                type: "GET",
                url: "{{url('rent_client_data')}}",
                data: {"id": id},
                success: function (data) {
                    $("#client_name").val(data.data.name);
                    $("#client_address").val(data.data.address);
    ...
    <script>
        $("#ad_id").change(function () {
            ...
            $.ajax({
                type: "GET",
                url: "{{url('rent_ad_data')}}",
                data: {"id": id},
                success: function (data) {
                    console.log(data);
                    $("#ad_name").val(data.data.title);
                    $("#ad_address").val(data.data.city.title + " " + data.data.district.title);
                    $("#ad_city").val(data.data.city.title)
                    $("#ad_district").val(data.data.district.title);
